...
func TestSkipList_Put(t *testing.T) {
	...
	res1 := sk.Put(nil, &data.RecordPst{Fid: 1, Offset: 100})
	assert.True(t, res1)

	res2 := sk.Put([]byte("a"), &data.RecordPst{Fid: 1, Offset: 200})
	assert.True(t, res2)
}
...
func TestSkipList_Get(t *testing.T) {
	...
	res2 := sk.Put([]byte("a"), &data.RecordPst{Fid: 1, Offset: 200})
	assert.True(t, res2)
	res3 := sk.Put([]byte("a"), &data.RecordPst{Fid: 1, Offset: 300})
	assert.True(t, res3)
...
func TestSkipList_Delete(t *testing.T) {
	...
	res3 := sk.Put([]byte("abc"), &data.RecordPst{Fid: 11, Offset: 22})
	assert.True(t, res3)
	res4 := sk.Delete([]byte("abc"))
	assert.True(t, res4)
	res5 := sk.Get([]byte("abc"))
	fmt.Println(res5 == nil)
	assert.Equal(t, (*data.RecordPst)(nil), res5)
}
...
func TestSkipList_Iterator(t *testing.T) {
	...
	sk1.Put([]byte("abc"), &data.RecordPst{Fid: 1, Offset: 12})
	...
	sk1.Put([]byte("bcd"), &data.RecordPst{Fid: 2, Offset: 12})
	sk1.Put([]byte("efg"), &data.RecordPst{Fid: 3, Offset: 12})
	sk1.Put([]byte("def"), &data.RecordPst{Fid: 4, Offset: 12})
